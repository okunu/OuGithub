...
import com.okunu.repos.vm.ReposIssueVHVM

/**
 * Created by okunu on 2025-04-03.
 * Email : okunu@qq.com.
 */
class ReposIssueAdapter : BaseRecyclerViewAdapter() {
    ...
    override fun onCreateViewHolder(
        ...
        return CommonRecyclerViewVH<ReposItemReposLayoutBinding, ReposModel>(
            parent,
            R.layout.repos_issue_item_repos_layout,
            ReposIssueVHVM(parent.context),
            BR.vm
        )
    }
}